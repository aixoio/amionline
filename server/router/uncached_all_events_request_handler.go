...
func register_uncached_all_events_request_handler(r *mux.Router, db_connecter *sql.DB, redis_client *redis.Client) {
	r.HandleFunc("/api/events/uncached", func(w http.ResponseWriter, r *http.Request) {
